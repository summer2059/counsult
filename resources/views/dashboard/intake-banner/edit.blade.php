    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <div class="card">
            ...
            <div class="card-body pt-0 mt-4">
                <form action="{{ route('intake-banner.update', $city->id) }}" method="POST" enctype="multipart/form-data"
                    id="bannerForm">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="col-12 mb-3 lang-field lang-english">
                        ...
                        @if ($city->image)
                            <div class="mt-2">
                                <img id="imagePreview" src="{{ asset('uploads/images/' . $city->image) }} " alt="Preview"
                    ...
                    <div class="col-12 mb-3 lang-field lang-japanese">
                        ...
                        @if ($city->image2)
                            <div class="mt-2">
                                <img id="image2Preview" src="{{ asset('uploads/images2/' . $city->image2) }}" alt="Preview"
                                    style="max-width: 200px;">
                            </div>
                        @endif
                    </div>
            ...
            <div class="card-footer text-end">
                <div class="col-sm-9 offset-sm-3">
                    ...
                    <a href="{{ route('intake-banner.index') }}" class="btn btn-light">Cancel</a>
                </div>
            </div>
            </form>
        </div>
