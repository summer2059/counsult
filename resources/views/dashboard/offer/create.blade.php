    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <div class="card">
            ...
            <div class="card-body pt-0 mt-4">
                <form action="{{ route('offer.store') }}" method="POST" enctype="multipart/form-data" id="bannerForm">
                    @csrf
                    ...
                    <div class="col-12 mb-3 lang-field lang-japanese">
                        <div class="form-floating mb-3">
                            <textarea name="jp_description" class="form-control summernote" id="summernote">{{ old('jp_description') }}</textarea>
