    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <div class="card">
            ...
            <div class="card-body pt-0 mt-4">
                <form action="{{ route('whyus-detail.update', $why->id) }}" method="POST" enctype="multipart/form-data"
                    id="bannerForm">
                    @csrf
                    @method('PATCH')
                    ...
                    <label for="descriptionInput">Description:</label>
                            <textarea name="description" class="form-control" id="summernote">{{ old('description', $why->description) }}</textarea>
                    </div>
                    ...
                    <!-- Image Preview -->
                    <div class="col-12 mb-3">
                        <img id="imagePreview" src="{{ asset('uploads/images/' . $why->image) }}" alt=""
