            ...
            <div class="card-header border-1 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        <h4>Add New why Us Detail</h4>
                    </div>
                </div>
            </div>
            <!-- Card Body -->
            <div class="card-body pt-0 mt-4">
                <form action="{{ route('whyus-detail.store') }}" method="POST" enctype="multipart/form-data"
                    id="bannerForm">
                    @csrf
                    ...
                    <div class="col-12 mb-3 lang-field lang-japanese">
                        <div class="form-floating mb-3">
                            <input class="form-control @error('jp_title') is-invalid @enderror" id="titleInput"
                                type="text" name="jp_title" placeholder="Full Name" value="{{ old('jp_title') }}">
                    ...
                    <div class="col-12 mb-3 lang-field lang-japanese">
                        <div class="form-floating mb-3">
                            ...
                            <label for="summernote">Description(jp)</label>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mb-3 lang-field lang-english">
                        <div class="form-floating mb-3">
                            <textarea name="description" class="form-control summernote" id="summernote">{{ old('description') }}</textarea>
                    ...
                    <div id="conditionalFields">
                        ...
                        <div class="col-12 mb-3 lang-field lang-japanese">
                            <div class="form-floating mb-3">
                                ...
                                <label for="image2Input">Upload Japanese Icon</label>
                                @error('image2')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
