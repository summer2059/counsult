...
@section('content')
    <div class="col-sm-12 col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <form action="{{ route('city-banner.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @if (isset($cd))
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description_en" class="form-control" rows="4">{{ old('description', $cd->description ?? '') }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jp_title" class="form-control" id="jp_title"
                                        value="{{ old('jp_title', $cd->jp_title ?? '') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="jp_description" id="description_jp" class="form-control" rows="4">{{ old('jp_description', $cd->jp_description ?? '') }}</textarea>
