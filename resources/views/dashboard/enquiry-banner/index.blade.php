            ...
            <div class="card-body">
                <div class="row g-3">
                    <form action="{{ route('enquiry-banner.update') }}"  method="post" enctype="multipart/form-data">
                        @csrf
                        @if (isset($eb))
                            <input type="text" name="id" id="id" value="{{$eb->id}}" hidden>
                        @endif
                        <div class="form-group">
                            <label for="title" class="col-sm-2 control-label">Title <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" name="title" class="form-control" id="title" value="{{ isset($eb) ? $eb->title : '' }}">
                                @if ($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea name="description" id="description" class="form-control" rows="4">{{ isset($eb) ? $eb->description : '' }}</textarea>
                            ...
                            <div class="col-sm-10">
                                ...
                                @if (isset($eb->image))
                                    <div class="half-width" style="margin: 10px 0px;">
                                        <p>Current Image</p>
                                        <img src="{{ $eb->getImage() }}" class="thumbnail img-responsive"
