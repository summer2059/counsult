    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <div class="card">
            ...
            <div class="card-body pt-0 mt-4">
                <form action="{{ route('service-category.update', $sc->id) }}" method="POST" enctype="multipart/form-data"
                    id="bannerForm">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <select class="form-control" disabled>
                            <option value="{{ $sc->type_id }}">{{ ucfirst($sc->type->type) }}</option>
                        </select>
                        <input type="hidden" name="type" value="{{ $sc->type->type }}">
                        <input type="hidden" name="type_id" value="{{ $sc->type_id }}">
                    </div>
                    ...
                    <div class="col-12 mb-3 lang-field lang-english">
                        ...
                        <textarea name="description" class="form-control summernote" id="summernote">{{ old('description', $sc->description) }}</textarea>
                    </div>
                    ...
                    <!-- Description -->
                    <div class="col-12 mb-3 lang-field lang-japanese">
                        <label for="descriptionInput">Description(jp):</label>
                        <textarea name="jp_description" class="form-control summernote" id="summernote">{{ old('jp_description', $sc->jp_description) }}</textarea>
                    </div>
                    ...
                    <div class="col-12 mb-3 lang-field lang-english">
                        ...
                        @if ($sc->image)
                            <div class="mt-2">
                                <img id="imagePreview" src="{{ asset('uploads/images/' . $sc->image) }} "
                    ...
                    <div class="col-12 mb-3 lang-field lang-japanese">
                        ...
                        @if ($sc->image2)
                            <div class="mt-2">
                                <img id="image2Preview" src="{{ asset('uploads/images2/' . $sc->image2) }}"
                                    alt="Preview" style="max-width: 200px;">
                            </div>
                        @endif
                    </div>
