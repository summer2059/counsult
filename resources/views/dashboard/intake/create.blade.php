            ...
            <div class="card-header border-1 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        <h4>Add New Intake</h4>
                    </div>
                </div>
            </div>
            <!-- Card Body -->
            <div class="card-body pt-0 mt-4">
                <form action="{{ route('intake.store') }}" method="POST" enctype="multipart/form-data"
                    id="bannerForm">
                    @csrf
                    ...
                    <div class="col-12 mb-3 lang-field lang-japanese">
                        <div class="form-floating mb-3">
                            <input class="form-control @error('jp_name') is-invalid @enderror" id="titleInput"
                                type="text" name="jp_title" placeholder="Title" value="{{ old('jp_name') }}">
                            <label for="titleInput">Title(Japan)</label>
                            @error('jp_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
