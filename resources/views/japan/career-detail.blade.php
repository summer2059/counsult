        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-7 col-12">
                    <div class="job-card">
                        <h3 class="job-title mb-4">{{ $career->jp_title }}</h3>
                        <p><strong>Position:</strong> {{ $career->jp_position }}</p>
                        ...
                        <p><strong>Job Posting Date:</strong> {{ $career->jp_start_date }}</p>
                        <p><strong>Application End Date:</strong> {{ $career->jp_end_date }}</p>
                ...
                <div class="col-xl-5 col-12">
                    <div class="contact apply-job p-4 shadow-sm rounded" style="background: var(--secondary);">
                        <div class="form-wrapper">
                            ...
                            <form class="d-flex flex-column gap-lg-4 gap-3" method="POST" action="{{route('jp.store.career')}}"
