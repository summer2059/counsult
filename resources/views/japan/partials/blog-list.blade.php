    ...
    <div class="col-xl-6 col-lg-12 col-md-6">
        <div class="blog-item">
            <div class="position-relative overflow-hidden">
                <img class="img-fluid" src="{{ asset('uploads/images/'.$blog->image) }}" alt="{{ $blog->jp_title }}">
            </div>
            <div class="bg-secondary d-flex">
                ...
                <div class="d-flex flex-column justify-content-center py-3 px-4">
                    <div class="d-flex mb-2">
                        ...
                        <small class="text-uppercase me-3"><i class="bi bi-bookmarks me-2"></i>{{ $blog->blogCategory->jp_title ?? 'Uncategorized' }}</small>
                    </div>
                    <a class="h4" href="{{ route('jp.blog.detail', $blog->jp_slug) }}">{{ $blog->jp_title }}</a>
                </div>
            </div>
        </div>
    </div>
