{{-- <div class="container-fluid bg-primary text-secondary p-5">
    ...
    <div class="container-fluid bg-dark text-secondary text-center border-top py-4 px-5" style="border-color: rgba(256, 256, 256, .1) !important;">
        <p class="m-0">&copy; <a class="text-secondary border-bottom" href="{{route('home-page')}}">Your Site Name</a>. All Rights Reserved. Designed by <a class="text-secondary border-bottom" onclick="sendMail()">HTML Codex</a></p>
    </div>
    <!-- Back to Top -->
